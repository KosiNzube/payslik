...
class LoanUpgradeScreen extends StatefulWidget {
  const LoanUpgradeScreen({super.key});

  @override
  State<LoanUpgradeScreen> createState() => _UpgradeScreenState();
}

class _UpgradeScreenState extends State<LoanUpgradeScreen> with SingleTickerProviderStateMixin {
  Color? _primaryColor;
