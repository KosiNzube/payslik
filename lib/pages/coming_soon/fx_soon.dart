...
class FxUpgradeScreen extends StatefulWidget {
  const FxUpgradeScreen({super.key});

  @override
  State<FxUpgradeScreen> createState() => _UpgradeScreenState();
}

class _UpgradeScreenState extends State<FxUpgradeScreen> with SingleTickerProviderStateMixin {
  Color? _primaryColor;
