...
class DashboardPage3 extends StatefulWidget {
  ...
  @override
  State<DashboardPage3> createState() => _DashboardPageState();
}
...
class _DashboardPageState extends State<DashboardPage3> {
  ...
  void _updateLocalData(Map<String, dynamic> profile) {
    ...
    _bankCode = profile["bank_code"] ?? "N/A";
    _walletCurrency = profile["wallet_currency"] ?? "N/A";
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                return _alreadyOpen==true? SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      UserInfoCard(username: _currentName!, accountNumber: _currentWalletNumber!, balance: _currentBalance, bankName: _currentBankName!, hasWallet: _currentHasWallet!, bankCode: _bankCode!, wallet_number: _currentWalletNumber, wallet_currency: _walletCurrency!, symbol: _currentCurrencySymbol!,),
