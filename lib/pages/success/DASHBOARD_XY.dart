...
class _DashboardPageState extends State<DashboardY> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        leading: const Icon(CupertinoIcons.flag, size: 16, color: Colors.white),
                        title: Row(
                          children: [
                            Text(
                              w['currency'] ?? "---",
  ...
  Widget _buildWalletCardUnified() {
    if (wallets.isEmpty) return Container(
                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(CupertinoIcons.flag, size: 16, color: Colors.white),
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Balance Amount
          Text(
            _isBalanceHidden ? "••••••" : "${wallet["currency"]} $formattedBalance",
            style: GoogleFonts.inter(
              fontSize: 28,
              fontWeight: FontWeight.bold,
              color: Colors.black87,
...
void showAccountDetailsModal(
    BuildContext context, {
      ...
      required String accountNumber, required bankName,
    }) {
  showModalBottomSheet(
    context: context,
    backgroundColor: Colors.transparent,
