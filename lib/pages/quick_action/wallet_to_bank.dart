              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                _buildDetailRow("AMOUNT", "${formatNumber(_amountController.text)}", isAmount: true),
                                const SizedBox(height: 20),
                                _buildDetailRow("RECIPIENT BANK", selectedBank ?? "Not Selected"),
                                const SizedBox(height: 20),
                                _buildDetailRow("ACCOUNT NUMBER", _accountNumberController.text),
                                const SizedBox(height: 20),
                                _buildDetailRow(
                                  "ACCOUNT NAME",
                                  context.read<WalletToBankTransferController>().beneficiaryName,
                                ),
                                const SizedBox(height: 20),
                                _buildDetailRow("NARRATION", _narrationController.text.isNotEmpty ? _narrationController.text : "Wallet to Bank Transfer"),
                                const SizedBox(height: 20),
                                _buildDetailRow("SAVE AS BENEFICIARY", saveBeneficiary ? "Yes" : "No"),
                              ],
                            ),
                          ),
                              ...
                              builder: (context, controller, child) {
                                ...
                                return SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: canProceed ? _confirmTransfer : null,
                    ...
                    if (isLoading || context.read<WalletToBankTransferController>().isProcessing)
                      Positioned.fill(
                        child: Container(
                          decoration: BoxDecoration(
