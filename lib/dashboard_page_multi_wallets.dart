...
class DashboardPageMultiWallets extends StatefulWidget {
  const DashboardPageMultiWallets({super.key});

  @override
  State<DashboardPageMultiWallets> createState() => _DashboardPageState();
}

class _DashboardPageState extends State<DashboardPageMultiWallets> {
